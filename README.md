...
UniProject is a Django-based web application developed as a final project at Software University (SoftUni). It simulates a modern online store where users can browse, search,purchase computers and computer components. The platform showcases full-stack development capabilities using Python and Django.
