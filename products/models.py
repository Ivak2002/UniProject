...
class RAM(models.Model):
    name = models.CharField(max_length=50, validators=[MinLengthValidator(10)], unique=True)
    image = models.URLField()
    type = models.CharField(max_length=15, validators=[MinLengthValidator(5)])
    frequency = models.CharField(max_length=15, validators=[MinLengthValidator(5)])
    megahertz = models.CharField(max_length=15, validators=[MinLengthValidator(5)])
    price = models.DecimalField(max_digits=8, decimal_places=2)
    created_at = models.DateTimeField(auto_now_add=True)
...
class BuiltComputers(models.Model):
    name = models.CharField(max_length=50, validators=[MinLengthValidator(10)], unique=True)
    image = models.URLField()
    ram = models.CharField(max_length=30, validators=[MinLengthValidator(10)])
    gpu = models.CharField(max_length=30, validators=[MinLengthValidator(10)])
    motherboard = models.CharField(max_length=30, validators=[MinLengthValidator(10)])
    cpu = models.CharField(max_length=30, validators=[MinLengthValidator(10)])
    box = models.CharField(max_length=50, validators=[MinLengthValidator(10)])
    storage = models.CharField(max_length=30, validators=[MinLengthValidator(10)])
    created_at = models.DateTimeField(auto_now_add=True)
    price = models.DecimalField(max_digits=8, decimal_places=2)
